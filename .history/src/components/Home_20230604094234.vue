<template>
    <div style="text-align: center;background-color: #f1f1f3;height: 100%;padding: 0px;margin: 0px;">
        <h1 style="font-size: 30px; margin-top: 20px;">{{'欢迎你！'+user.name}}</h1>
        <el-descriptions  title="个人中心" :column="2" size="40" border style="text-align:center">
            <el-descriptions-item :contentStyle="{'text-align': 'center'}">
                <template slot="label" >
                    <i class="el-icon-s-custom" :contentStyle="{'text-align': 'center'}"></i>
                    账号
                </template>
                {{user.no}}
