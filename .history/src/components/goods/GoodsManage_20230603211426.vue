<template>
    <div>
        <div style="margin-bottom: 5px;">
            ...
            <el-button type="primary" style="margin-left: 10px;" @click="add" v-if="user.id!=2">新增</el-button>
            <el-button type="primary" style="margin-left: 10px;" @click="inGoods">入库</el-button>
            <el-button type="primary" style="margin-left: 10px;" @click="outGoods">出库</el-button>
        </div>
